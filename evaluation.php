            ...
            <form class="mb-3" action="" method="get" name="modules">
                ...
                <div class="form-floating mb-3">
                    <select class="form-select" name="module" onchange="this.form.submit()">
                        ...
                        $query = $bdd->query('SELECT modules.idModule, libelle, reference FROM affectation
                ...
                while ($resultat = $query->fetch_object()) {
                    ...
                    <td>
                        <select name="note-<?php echo $resultat->idStagiaire ?>">
                            <?php $queryNiveau = $bdd->query('SELECT libelle FROM niveau');
                            while ($resultatNiveau = $queryNiveau->fetch_object()) {
                                echo "<option>" . $resultatNiveau->libelle . "</option>";
                            }
                            $queryNiveau->close(); ?>
                        </select>
                    </td>
